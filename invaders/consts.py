...
STATE_INACTIVE = 0
# state when displaying the instructions
STATE_INSTRUCTION = .5
...
# the default font size of text
FONT_SIZE = 60
# the default font name
FONT_NAME = 'Arcade'
# the default text height
TEXT2_HEIGHT = GAME_HEIGHT*2/5
# the default x coordinate of text displaying lives
LIVESBOX_X = 700
# the default y coordinate of text displaying lives
LIVESBOX_Y = 670
# the basic score of an alien
BASIC_SCORE = 10
# the speed factor inside one wave; adding when alien gets killed
SPEED_FACTOR = .97
# the speed factor when game level increases; adding for the start of a new wave
SPEED_FACTOR2 = .8
# the x coordinate of text
TEXT_X = GAME_WIDTH/2*10/27
# the x coordinate of text2
TEXT_X2 = GAME_WIDTH/2*15/27
# the x coordinate of text3
TEXT_X3 = GAME_WIDTH/2*18/27
# the y coordinate of text0
TEXT_Y0 = GAME_HEIGHT*5/6
# the y coordinate of text
TEXT_Y = GAME_HEIGHT*5/6-80
# the y coordinate of text2
TEXT_Y2 = GAME_HEIGHT*5/6-80*2
# the y coordinate of text3
TEXT_Y3 = GAME_HEIGHT*5/6-80*3
# the y coordinate of text4
TEXT_Y4 = GAME_HEIGHT*5/6-80*4
